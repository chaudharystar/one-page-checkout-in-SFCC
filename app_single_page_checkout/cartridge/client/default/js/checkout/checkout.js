...
var formHelpers = require('baseJs/checkout/formErrors');
var scrollAnimate = require('baseJs/components/scrollAnimate');
var customerHelpers = require('baseJs/checkout/customer');

var baseCheckout = require('baseJs/checkout/checkout');
...
(function ($) {
    $.fn.checkout = function () {
        ...
        //
        var checkoutStages = ['customer', 'single_page'];
        ...
        var members = {
            ...
            updateStage: function () {
                ...
                if (stage === 'customer') {
                    ...
                    var billingAddressFormData = billingAddressForm.serialize();
                    ...
                    var paymentForm = `${billingAddressFormData}&${contactInfoForm}&${paymentInfoForm}`;
                    ...
                    // disable the next:checkout button here
                    $('body').trigger(
                    ...
                    var allFormData;
                    if (!isMultiShip) {
                        allFormData = shippingFormData + paymentForm;
                    } else {
                        allFormData = paymentForm;
                    }

                    $.ajax({
                        url: $('.single-page').data('action'),
                        type: 'post',
                        data: allFormData,
                        success: function (data) {
                            // enable the next:checkout button here
                            $('body').trigger(
